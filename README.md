...
| **usage_log_path** | Local JSONL file used for `/monitor` usage history, cost windows, demand pressure, request shape, and top messenger/spender stats.<br /><br />Suggested default: `usage.jsonl` |
